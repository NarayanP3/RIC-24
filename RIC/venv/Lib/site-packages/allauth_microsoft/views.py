...
class MicrosoftAuth2Adapter(OAuth2Adapter):
    ...
    authorize_url = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize"#.format(tenant=tenant)
    access_token_url = "https://login.microsoftonline.com/common/oauth2/v2.0/token"#.format(tenant=tenant)
